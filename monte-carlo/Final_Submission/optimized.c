...
//Function Description : kernel for determining number of points inside circle
//@args
...
int main(int argc, char* argv[])
{
	...
	//But the processor might be running on turbo mode, since I am not
	//using many cores, this is just a single core code.
